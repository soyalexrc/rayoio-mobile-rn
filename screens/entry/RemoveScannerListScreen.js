...
export default function RemoveScannerListScreen({navigation}) {
  ...
  return (
    <View style={styles.container}>
      <View style={{padding: 20, alignItems: 'center'}}>
        ...
        <Text>Resumen de productos removidos</Text>
      </View>
      <View style={styles.slots}>
        ...
        <View >
          <TouchableOpacity style={styles.rescan} onPress={() => {navigation.navigate('RemoveScanner')}}>
            <Image
